...
public class CalView extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Calendar<Entry<String>> availableCal = new Calendar<>("Available Time");
        availableCal.setStyle(Calendar.Style.STYLE1);

        Calendar<Entry<String>> taskCal = new Calendar<>("Scheduled Tasks");
        taskCal.setStyle(Calendar.Style.STYLE2);

        Calendar<Entry<String>> deepWorkCal = new Calendar<>("Deep Work");
